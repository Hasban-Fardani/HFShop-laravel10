...
<div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="container">
        <div class="row p-5">
          <div class="col-md-8 col-lg-6 order-lg-last mx-auto">
            <img class="img-fluid" src="{{asset('assets/user/img/banner_img_01.jpg')}}" alt="">
          </div>
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row p-5">
          <div class="col-md-8 col-lg-6 order-lg-last mx-auto">
            <img class="img-fluid" src="{{asset('assets/user/img/banner_img_02.jpg')}}" alt="">
          </div>
          <div class="col-lg-6 d-flex align-items-center mb-0">
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row p-5">
          <div class="col-md-8 col-lg-6 order-lg-last mx-auto">
            <img class="img-fluid" src="{{asset('assets/user/img/banner_img_03.jpg')}}" alt="">
          </div>
          <div class="col-lg-6 d-flex align-items-center mb-0">
            <div class="text-align-left">
